...
class ToolExecutor:
    """Shared tool execution logic used by both Agent and pipeline Executor."""
    ...
    def execute(self, name: str, args: dict) -> str:
        try:
            if name == "inspect":
                return self.inspect(args.get("name", ""))
            ...
            if self.registry.has(name):
                ...
                return self.maybe_inject_hint(name, result)
    ...
    def maybe_inject_hint(self, fn_name: str, result: str) -> str:
        notes: list[str] = []
        ...
        for _ in range(self.max_turns):
            ...
            if tool_calls_acc:
                ...
                for tc in tool_calls_acc.values():
                    ...
                    result = self.tool_executor.execute(tc["name"], json.loads(tc["arguments"]))
